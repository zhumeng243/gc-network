...
if __name__ == '__main__':
    ...
    train_dataset = KITTI2015('E:/data_scene_flow2015', mode='train', transform=train_transform)
    train_loader = DataLoader(train_dataset)
    print(len(train_loader))

    validate_transform = T.Compose([ToTensor(), Normalize(mean, std), Pad(384, 1248)])
    validate_dataset = KITTI2015('E:/data_scene_flow2015', mode='validate', transform=validate_transform)
